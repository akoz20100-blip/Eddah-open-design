...
const features: Feature[] = [
  {
    image: "toolsFloat",
    eyebrow: "إتقان التفاصيل",
    title: (
      <>
        اللي يفهم التفاصيل الصغيرة
        <span className="text-orange-gradient"> يسيطر على الكبيرة</span>
      </>
    ),
    body: "كل وصلة، وكل زاوية، وكل قطعة محسوبة. غلطة صغيرة قد تكلّفك كثيرًا، لذلك نبني كل عمل على دقّة لا تتحمّل الخطأ — بأدوات احترافية وأيدٍ تعرف ما تفعل.",
    points: ["فحص قبل وبعد كل خدمة", "أدوات احترافية لكل مهمة", "تسليم نظيف ومرتّب"],
    aspect: "aspect-[4/5]",
  },
  {
    image: "products",
    ...
    body: "تعتمد علينا فتعرف أن الموضوع انتهى وراحة البال في يدك. قطع موثوقة وتنفيذ هادئ محترف — خدمة تتم بثقة، وتبقى نتيجتها معك طويلًا.",
    points: ["قطع وأدوات موثوقة", "التزام بالموعد المتفق عليه", "متابعة بعد إتمام العمل"],
    flip: true,
    aspect: "aspect-[4/3]",
  },
];
